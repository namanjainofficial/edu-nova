...
//  Create a new course API GATEWAY
...
export const fetchCourseCategories = async () => {
  ...
  try {
    ...
    console.log("Fetch Course Categories Successfully");
    if (!response?.data?.success) {
    ...
    console.log("Fetch Course Categories ERROR............", error);
    toast.error(error.message);
  }
  return result;
};
...
export const editCourseDetails = async (token, formData) => {
  ...
  try {
    ...
    if (!response?.data?.success) {
      throw new Error("Couldn't Edit Course Detail");
    }
