...
const Home = () => {
  return (
    <div>
      ...
      >
        {/* link bnne ke link ko use krege */}
        <Link to={"/signup"}>
          {/* neeche wale div ko round krne ke liye */}
          <div
            className="group mt-16 p-1 mx-auto rounded-full bg-richblack-800 font-bold text-richblack-200
          transiton-all duration-200 hover:scale-95"
          >
            {/* iss wale div ko content daalne ke liye use krege */}
            <div
        ...
        <div className="w-[80%] text-center text-lg font-bold text-richblack-300 mt-4">
      ...
      <div className="bg-pure-greys-5 text-richblack-700">
        <div className="homepage_bg h-[300px]">
          <div
            className="w-11/12 h-[100%] max-w-maxContent flex flex-col justify-center 
                items-center mx-auto"
          >
            <div className="flex flex-row justify-center gap-7 text-white">
              <CTAButton active={true} linkto={"/signup"}>
        ...
        <div
          className="w-11/12 max-w-maxContent flex flex-col items-center justify-center
        mx-auto"
        >
          <div className="flex flex-row justify-center gap-5 mb-10 mt-[95px]">
            <div className="text-5xl text-semibold w-[40%]">
      ...
      <div className="w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between
        ...
        <InstructorSection />
        <h2 className="text-4xl text-center font-semibold">Review from Others learners</h2>
